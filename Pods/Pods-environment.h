...
// FAAnaconda
#define COCOAPODS_POD_AVAILABLE_FAAnaconda
#define COCOAPODS_VERSION_MAJOR_FAAnaconda 0
#define COCOAPODS_VERSION_MINOR_FAAnaconda 0
#define COCOAPODS_VERSION_PATCH_FAAnaconda 1
